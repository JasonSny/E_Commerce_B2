...
@section('content')
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Modifier : <strong> {{ $product->title }}</strong></div>
                    <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="subtitle" type="text"
                                        ...
                                        value="{{ old('subtitle') ?? $product->subtitle }}" required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input id="stock" type="number"
                                        ...
                                        value="{{ old('stock') ?? $product->stock }}" required autocomplete="stock"
                                        autofocus>
